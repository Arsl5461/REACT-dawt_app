...
function User() {
    ...
    const [stdName,setStdName]=useState(["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"])
  ...
  //  const name=()=>{
  //     setUserName("Ali Akmal")
  //     setUserAge(279)
  //     setUserEmail("ali@gmail.com")
  //     setUserPhone("03021548799")
  //     setUserPassword("asjcvhasvcjhs")
...
{products.map((item)=>{
  ...
  <div class="card-body">
    ...
    <p class="card-text">{item.description.slice(0,35)}</p>
    ...
    <h1 className="title">Arslan Akmal</h1>
